...
public class TransferenciaServiceTest {
    ...
    public void findAllTransferenciaByContaIdAndNomeOperadorTransacaoAndDataTransferenciaBetween() {
        List<Transferencia> transferencias = transferenciaService
                .findAllTransferenciaByContaId(pageable, 1, "Beltrano", "2019-06-08T04:15:01", "2020-06-08T04:15:01")
                .getContent();
    ...
    public void findAllTransferenciaByContaIdAndDataTransferenciaBetween2() {
        List<Transferencia> transferencias = transferenciaService
                .findAllTransferenciaByContaId(pageable, 2, null, "2019-06-08T04:15:01", "2021-12-01T06:12:04")
                .getContent();

        assertEquals(2, transferencias.size());
        assertEquals("2019-08-07T02:12:45", transferencias.get(0).getDataTransferencia().toString());
        assertEquals("2021-04-01T06:12:04", transferencias.get(1).getDataTransferencia().toString());
    }

    @Test
    public void findAllTransferenciaByContaIdAndDataTransferenciaBetween1() {
        List<Transferencia> transferencias = transferenciaService
                .findAllTransferenciaByContaId(pageable, 2, null, "2019-06-08T04:15:01", "2019-12-01T06:12:04")
                .getContent();
